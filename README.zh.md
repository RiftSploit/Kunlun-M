...
目前工具主要支持 **PHP、JavaScript、Java** 的语义分析，以及 **Chrome Extension、Solidity** 的基础扫描。

**Java 扫描引擎**（v2.9.0）支持基于 AST 的污点分析、框架级漏洞检测（Shiro/Struts2/Log4j/Fastjson 等），内置 58 条规则覆盖 20+ 漏洞类型。
